...
hero:
  ...
  image: "/img/earthcode-heropage-v2.jpg"
  actions:
    - theme: cta
      text: Get started
...
" />
  ...
  <a class="VPButton cta no-icon primary" href="https://assets-eur.mkt.dynamics.com/846bcca8-9413-4d04-822b-7282239af232/digitalassets/standaloneforms/1596564b-a729-f011-8c4d-7c1e52350f4e" target="_blank">Subscribe</a>
  </div>
  </div>
</section>
...
<esa-cards>
  ...
  <esa-card
    ...
    description="Monthly gridded δ13C(CH₄) isotopic signatures (‰ vs V-PDB) for five methane emission sectors: AGW, FFG, BB, NAT, WET, and their subsequent sub-sectors, at 1°×1° spatial resolution for the period 1998–2022. Available in cloud-optimised format. <br /><br /><img src='/img/SMART_CH4_dataset_icon.png' height='100' style='max-width: 100%; object-fit: contain' />"
  ...
  <esa-card
    ...
    description="Explore how the ESA CCI Permafrost datacube was generated using DeepESDL platforms built-in tools and open source libraries. Access and execute the code in DeepESDL environment. Configuration files available as well. <br /><br /><img src='/img/ECA_CCI_permafrost_cube_DeepESDL.png' height='100' style='max-width: 100%; object-fit: contain' />"
